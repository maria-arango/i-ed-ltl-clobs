...
void main() {
  ...
  // Light end is the paper token (#FBF8F1), never pure white (DESIGN_SYSTEM §7).
  vec3 white = vec3(0.984, 0.973, 0.945);
...
const FluidOrb = ({
  size = 240,
  // Lake (--clobs-lake). Landing page only, at most one instance (DESIGN_SYSTEM §5).
  color = '#2C5C8F',
  className,
  style,
  ...props
